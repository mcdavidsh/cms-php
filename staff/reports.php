...
{ $rstatus = "Reported";
    ...
    move_uploaded_file($_FILES["rfile"]["tmp_name"],"../_uploads/report/".$_FILES["rfile"]["name"]);
                    ...
                    <form class="form-horizontal style-form" method="post" name="complaint" enctype="multipart/form-data">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <textarea name="rremark"  required rows="9" class="form-control" placeholder="Type Remarks..." class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="table table-responsive table-responsive-data2">
                            <table id="example" class="table nowrap table-data2" style="width:100%">
                                ...
                                <tr class="tr-shadow">
                                    ...
                                    <td>   <a class="btn btn-primary btn-sm" href="report-details.php?cid=<?php echo htmlentities($row['rcomplaintNumber']);?>"> View Details</a>
                                    </td>
                                </tr>
                                <?php }?>
                                <!--                                    <tr class="spacer"></tr>-->
