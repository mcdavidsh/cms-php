                    ...
                    <form class="form-horizontal style-form" method="post" name="chngpwd" onSubmit="return valid();">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input placeholder="Current Password" type="password" name="password" required="required" autofocus class="form-control">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="password" name="newpassword" required="required" class="form-control" placeholder="New Password">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="password" name="confirmpassword" required="required" class="form-control" placeholder="Confirm New Password">
