        ...
        <div class="col-md-6 col-lg-6 offset-md-3">
            <div class="card">
                ...
                <div class="card-body card-block">
                    ...
                    <form class="form-horizontal style-form" method="post" name="Category" method="post"
                        ...
                        while ($row = mysqli_fetch_array($query)) {
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" required="required" rows="9" class="form-control"
                                          maxlength="2000" placeholder="Enter type description"
                                          class="form-control"><?php echo htmlentities($row['categoryDescription']); ?></textarea>
                            </div>
                        <?php } ?>
