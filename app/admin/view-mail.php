                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6">
                                                ...
                                                <div class="col card-title" style="font-size: 18px; font-weight: 600;">
                                                    Sender: <span class="card-text pl-2"
                                                                  style="font-weight: lighter; font-size: 14px;"><?php echo($row['sender']); ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-lg-6">
                                                <div class="col card-title" style="font-size: 18px; font-weight: 600;">
                                                    Email: <span class="card-text pl-2"
                                                                 style="font-weight: lighter; font-size: 14px;"><?php echo($row['email']); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row py-3">
                                            <div class="col-md-8 col-lg-8">
                                                <div class="col card-title" style="font-size: 18px; font-weight: 600;">
                                                    Subject: <span class="card-text pl-2"
                                                                   style="font-weight: lighter; font-size: 14px;"><?php echo($row['subject']); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row py-3">
                                            <div class="col-md-10 col-lg-10">
                                                <div class="col card-title" style="font-size: 18px; font-weight: 600;">
                                                    Message: <span class="card-text pl-2"
                                                                   style="font-weight: lighter; font-size: 14px;"><?php echo($row['message']); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row ml-auto mr-auto form-group">
                                                <div class="col-md-8 col-lg-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="sender"
                                                               placeholder="<?php echo "Replying as" . ' ' . ucwords($_SESSION['alogin']); ?>"
                                                               disabled
                                                               class="form-control">
                                                        <label for="Title"
                                                               class=" form-control-label py-2"> <?php echo "Send to:" . ' ' . ucwords($row['sender']); ?></label>
                                                        <input type="text" name="recmail"
                                                ...
                                                <div class="col-md-8 col-lg-8">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="message" required onkeyup="callOnPageLoad()"
                                                                  id="textareaEx"
                                                                  style="overflow:hidden; text-align: left; margin: 0; padding: 0;"
...
"
                                            ...
                                            <button type="submit" class="btn btn-danger display-4" name="submit">Reply
                                                Email
                                            </button>
                                        </form>
